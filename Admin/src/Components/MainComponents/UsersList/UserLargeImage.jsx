        ...
        <>
            <div className='flex flex-col justify-center items-center gap-3'>
                ...
                <ButtonGroup className='flex gap-2'>
                    <Button onClick={() => handleOpen("suspendModal")} className='rounded-lg font-custom capitalize tracking-wider bg-processingBg border-none'>
                        Suspend</Button>
                    <Button onClick={() => handleOpen("reactivateModal")} className='rounded-lg font-custom capitalize tracking-wider bg-shippedBg border-none'>
                        Reactivate</Button>
                    <Button onClick={() => handleOpen("deleteProfileModal")} className='rounded-lg font-custom capitalize tracking-wider bg-deleteBg border-none'>
                        Delete</Button>
                </ButtonGroup>
            </div>
