    ...
    return (
        <>
            <Dialog open={open} handler={handleOpen} size={"xs"}
                className="fixed right-0 top-5 transform -translate-x-1 w-1/3 pt-10 px-3"
            >
                <DialogBody className='flex flex-col justify-center items-center space-y-4'>
                    ...
                    <div className='space-y-3'>
                        <div>
                            <h1 className='text-base font-semibold text-secondary mb-2'>Description</h1>
                        ...
                        <div>
                            <h2 className='text-base font-semibold text-secondary mb-2'>Sub Categories</h2>
                ...
                <DialogFooter className='flex justify-center items-center gap-1'>
                    ...
                    <Button onClick={handleOpen} 
                        className='w-40 bg-primary/20 text-primary font-custom capitalize tracking-wider'>
                        <span>delete</span>
                    </Button>
                </DialogFooter>
            </Dialog>
